        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Gestionar informacion de Compañía</h3>
            </div>
            <form role="form" action="<?php base_url('company/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="service_charge_value">Cobro sobre Servicio (%)</label>
                ...
                <div class="form-group">
                  <label for="vat_charge_value">Impuesto sobre la Renta (%)</label>
